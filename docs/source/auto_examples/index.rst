...
.. only:: html
  ...
  .. image:: /auto_examples/images/thumb/sphx_glr_example_2_single_atom_RIXS_thumb.png
    :alt: RIXS calculations for an atomic model
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="When defining the bath states, it is useful to use the so-called symmetry adapted linear combin...">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_example_3_AIM_XAS_thumb.png
    :alt: Anderson impurity model for NiO XAS
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="In doing this we will go through the exercise of building and diagonalizing the Hamiltonian in ...">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_example_4_GS_analysis_thumb.png
    :alt: Ground state analysis for NiO
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="This case was chosen because the eigenvectors in question are simple enough for us to write the...">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_example_5_transitions_thumb.png
    :alt: X-ray transitions

  :ref:`sphx_glr_auto_examples_example_5_transitions.py`
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="  .. math::     \begin{equation}     \hat{H} = \sum_{i,j}  \sum_{\sigma} t_{i,j} \hat{f}^{\dagg...">
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="The simplest model that captures this physics requires four Ni spin-orbitals, representing the ...">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_example_7_Hunds_interactions_thumb.png
    :alt: Hund's Interactions in charge transfer insulators

  :ref:`sphx_glr_auto_examples_example_7_Hunds_interactions.py`
...
.. only:: html
  ...
  .. image:: /auto_examples/images/thumb/sphx_glr_example_8_Coulomb_thumb.png
    :alt: Coulomb interactions

  :ref:`sphx_glr_auto_examples_example_8_Coulomb.py`
...
.. toctree::
   ...
   /auto_examples/example_5_transitions
   /auto_examples/example_6_Hubbard_dimer
   /auto_examples/example_7_Hunds_interactions
   /auto_examples/example_8_Coulomb
